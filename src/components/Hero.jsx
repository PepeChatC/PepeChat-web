...
const prices = [
  0.01, 0.02, 0.05, 0.1, 0.04, 0.06, 0.07, 0.06, 1, 1.5,
  2, 1.9, 1.8, 1.85, 1.5, 2, 2.5, 3.5, 2, 1.2,
  1.6, 2, 2.5, 2.7, 2.9, 3, 3.2, 3.5, 3.7, 3.9,
  4, 4.5, 5,
]
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            ...
            <div className="text-sm text-gray-900">$PEPEC</div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              A revolutionary decentralized social media platform,Tailored for all your requirements.
            </p>
            ...
            <Button
                ...
                variant="outline"
              >
                <span className="ml-2.5">Buy On Uniswap</span>
              </Button>
