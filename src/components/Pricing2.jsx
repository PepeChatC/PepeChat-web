...
export function Pricing() {
  let [activePeriod, setActivePeriod] = useState('Inception')
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          We Hope To Achieve The Following in our inception and finale phases:
          </p>
        </div>
